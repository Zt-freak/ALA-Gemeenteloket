                ...
                switch ($_GET["lang"]) {
                    case "nl":
                        ...
                        <form action='' method='post'>
                            ...
                            <label>Kies een tijdstip voor uw afspraak</label><br>
                            <input required type='time' name='time'><br>
                    ...
                    case "en":
                        ...
                        <form action='' method='post'>
                            ...
                            <label>Pick a preferred time</label><br>
                            <input required type='time' name='time'><br>
                    ...
                    case "arno":
                        ...
                        <form action='' method='post'>
                            ...
                            <label>Arno een tijdsarno voor uw arnospraak</label><br>
                            <input required type='time' name='time'><br>
                    ...
                    if (isset($_GET["lang"])) {
                        switch ($_GET["lang"]) {
                            case "nl":
                                ...
                                echo "Uw datum en tijd van voorkeur: ".$_POST["date"].", ".$_POST["time"]."<br>";
                            ...
                            case "en":
                                ...
                                echo "Preferred date and time: ".$_POST["date"].", ".$_POST["time"]."<br>";
